...
Welcome to the Bubble Pop app for Android!

This is an open source Android app developed by Stephan van der Burg. The source code is available on GitHub under the GNU AGPL license (3.0 or later).
...
| `android.permission.INTERNET` | This permission allows the app to download new game levels without needing a new version release. |
